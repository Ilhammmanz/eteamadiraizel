    ...
    <div class="col-12 mb-2">
        ...
        <div class="d-flex align-items-center gap-3">
            <div class="avatar-upload-box flex-shrink-0">
                <img id="imagePreview" 
                     src="{{ isset($user) && $user->photo ? asset('storage/' . $user->photo) : 'https://ui-avatars.com/api/?name=' . urlencode(isset($user) ? $user->name : 'User') . '&background=f3e8ff&color=7c3aed' }}" 
                     alt="Preview Foto" 
                     class="avatar-preview-img"
                     onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($user->name ?? 'User') }}&background=f3e8ff&color=7c3aed';">
            </div>
            <div>
                <input type="file" 
                       name="photo" 
