...
@section('title', __('Tambah Kategori') . ' - POS ILHAM')
    ...
    <div class="dashboard-header-banner position-relative overflow-hidden">
        <div class="position-relative" style="z-index: 1;">
            <h2 class="fw-bold text-white mb-2 d-flex align-items-center gap-2">
                <i class="bi bi-plus-circle-fill fs-2"></i> {{ __('Tambah Kategori Baru') }}
            </h2>
            <p class="text-white opacity-75 mb-0">{{ __('Tambahkan jenis produk baru ke dalam sistem kasir Anda.') }}</p>
        </div>
        <div class="position-absolute end-0 bottom-0 opacity-15 pe-4 pb-2 d-none d-md-block">
            <i class="bi bi-tags-fill text-white" style="font-size: 6rem;"></i>
        </div>
    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 @error('nama') is-invalid @enderror"
                                   ...
                                   style="border-radius: 0 var(--radius-md) var(--radius-md) 0;" required autocomplete="off">
                        </div>
                        @error('nama')
