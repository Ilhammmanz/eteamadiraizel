...
<?php $__env->startSection('title', 'Riwayat Penjualan - POS ILHAM'); ?>
                ...
                <div class="row g-2 align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="position-relative search-box">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control input-pill ps-5 py-2 bg-search" placeholder="Cari transaksi..." style="border-color: #ddd6fe;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 d-flex flex-wrap align-items-center justify-content-md-end gap-2">
                        <select name="status" class="form-select select-pill w-auto py-2 px-3 bg-search" onchange="this.form.submit()" style="border-color: #ddd6fe; color: var(--text-body);">
                            ...
                            <option value="complete" <?php echo e(request('status') == 'complete' ? 'selected' : ''); ?>>Selesai</option>
                        </select>
                        ...
                        <select name="metode" class="form-select select-pill w-auto py-2 px-3 bg-search" onchange="this.form.submit()" style="border-color: #ddd6fe; color: var(--text-body);">
                            ...
                            <option value="tunai" <?php echo e(request('metode') == 'tunai' ? 'selected' : ''); ?>>Tunai</option>
                            <option value="qris" <?php echo e(request('metode') == 'qris' ? 'selected' : ''); ?>>QRIS</option>
                            <option value="transfer" <?php echo e(request('metode') == 'transfer' ? 'selected' : ''); ?>>Transfer</option>
                        </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-purple d-inline-flex align-items-center gap-1.5 fs-7">
                                    ...
                                    <span><?php echo e($sale->user->name ?? 'Kasir'); ?></span>
                                </span>
                            </td>
                                    ...
                                    <div class="d-flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-light text-dark border px-2 py-1 rounded-2 fs-7 fw-normal">
                                                <strong><?php echo e($item->produk->nama ?? 'Produk'); ?></strong>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/penjualan/index.blade.php ENDPATH**/ ?>