                ...
                <div class="card dashboard-card h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="receipt_footer_msg" id="receipt_footer_msg" class="form-control" rows="2" placeholder="Terima Kasih Atas Kunjungan Anda!"><?php echo e(old('receipt_footer_msg', $user->receipt_footer_msg ?? 'Terima Kasih!')); ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="receipt_social" class="form-label">Info Sosial Media / Website</label>
                            <input type="text" name="receipt_social" id="receipt_social" class="form-control" placeholder="IG: @tokokamu | www.tokokamu.com" value="<?php echo e(old('receipt_social', $user->receipt_social ?? '')); ?>">
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->show_qr_on_receipt ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="show_qr_on_receipt" value="1" <?php echo e(($user->show_qr_on_receipt ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="paper_size" id="paper_size" class="form-select">
                                <option value="58mm" <?php echo e((old('paper_size', $user->paper_size ?? '') == '58mm') ? 'selected' : ''); ?>>58 mm (Struk Kecil Standard)</option>
                                <option value="80mm" <?php echo e((old('paper_size', $user->paper_size ?? '') == '80mm') ? 'selected' : ''); ?>>80 mm (Struk Lebar / Kasir Besar)</option>
                            </select>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3 mb-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->auto_print_receipt ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="auto_print_receipt" value="1" <?php echo e(($user->auto_print_receipt ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->open_cash_drawer ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="open_cash_drawer" value="1" <?php echo e(($user->open_cash_drawer ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card dashboard-card h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3 mb-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->show_cashier_name ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="show_cashier_name" value="1" <?php echo e(($user->show_cashier_name ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3 mb-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->show_customer_name ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="show_customer_name" value="1" <?php echo e(($user->show_customer_name ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-3 px-3 rounded-3" style="background: var(--icon-bg); border: 1px solid var(--card-border);">
                            ...
                            <div class="flex-shrink-0">
                                <div class="toggle-switch <?php echo e(($user->show_tax_discount_breakdown ?? true) ? 'active' : ''); ?>" onclick="toggleSwitch(this)">
                                    <input type="checkbox" name="show_tax_discount_breakdown" value="1" <?php echo e(($user->show_tax_discount_breakdown ?? true) ? 'checked' : ''); ?> hidden>
                                </div>
                            </div>
                        </div>
                    </div>
