...
<?php $__env->startSection('title', 'Detail Transaksi #' . $penjualan->id); ?>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div>
                <h2 class="fw-bold mb-1 text-white d-flex align-items-center gap-2">
                    <i class="bi bi-receipt fs-2"></i> Detail Transaksi #<?php echo e($penjualan->id); ?>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-outline-light rounded-pill px-4 fw-semibold shadow-sm d-flex align-items-center gap-1">
                ...
                <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <div>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="fw-bold text-dark fs-6">#<?php echo e($penjualan->id); ?></span>
                        </div>

                        <div class="mb-3">
                            <label class="text-muted small d-block">Tanggal Transaksi</label>
                            <span class="fw-semibold text-dark"><?php echo e($penjualan->created_at->translatedFormat('d F Y, H:i')); ?> WIB</span>
                        </div>

                        <div class="mb-3">
                            <label class="text-muted small d-block">Kasir / Petugas</label>
                            <span class="fw-semibold text-dark"><?php echo e($cashierName); ?> (<?php echo e($cashierRole); ?>)</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <?php if(strtoupper($penjualan->status) === 'COMPLETED' || strtoupper($penjualan->status) === 'SELESAI'): ?>
                            ...
                            <?php else: ?>
                                <span class="badge bg-warning-subtle text-warning border border-warning-subtle px-3 py-2 rounded-pill fw-semibold">
                                    <i class="bi bi-clock-history me-1"></i> <?php echo e(ucfirst($penjualan->status)); ?>
                    ...
                    <div class="text-center pt-2">
                        <div class="qr-container shadow-sm mb-2">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=130x130&data=<?php echo e(urlencode(route('penjualan.show', $penjualan->id))); ?>" 
                                 alt="QR Code Transaksi #<?php echo e($penjualan->id); ?>" 
                                 class="img-fluid"
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $penjualan->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <div class="fw-semibold text-dark"><?php echo e($item->produk->nama ?? $item->produk->nama_produk ?? 'Produk Terhapus'); ?></div>
                                        </td>
                                        <td class="text-end">Rp <?php echo e(number_format($item->harga_satuan ?? ($item->subtotal / max($item->kuantitas, 1)), 0, ',', '.')); ?></td>
                                        <td class="text-center">
                                            <span class="badge bg-light text-dark border px-2 py-1"><?php echo e($item->kuantitas); ?></span>
                                        </td>
...
<div id="receipt-print-area">
    <div style="text-align: center; border-bottom: 2px dashed #8b5cf6; padding-bottom: 8px; margin-bottom: 8px;">
        ...
        <p style="margin: 3px 0 0 0; font-size: 9px; color: #4b5563;">
            <?php echo e($storeAddress); ?>

        </p>
        <p style="margin: 1px 0 0 0; font-size: 9px; color: #4b5563;">
            Telp / WA: <?php echo e($storePhone); ?>
    ...
    <table style="width: 100%; font-size: 9px; border-collapse: collapse; margin-bottom: 6px; color: #1f2937;">
        <tr>
            ...
            <td style="text-align: right; padding: 2px 0; font-weight: bold; color: #8b5cf6;">#<?php echo e($penjualan->id); ?></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Tanggal:</td>
            <td style="text-align: right; padding: 2px 0;"><?php echo e($penjualan->created_at->format('d/m/Y H:i')); ?></td>
        </tr>
        <tr>
            <td style="padding: 2px 0;">Kasir:</td>
            <td style="text-align: right; padding: 2px 0; font-weight: bold;"><?php echo e($cashierName); ?> (<?php echo e($cashierRole); ?>)</td>
        </tr>
        <tr>
        ...
        <?php $__currentLoopData = $penjualan->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td colspan="2" style="font-weight: bold; padding-top: 3px;">
                    <?php echo e($item->produk->nama ?? $item->produk->nama_produk ?? 'Produk'); ?>

                </td>
            </tr>
            <tr>
                <td style="padding-bottom: 4px; color: #4b5563;">
                    <?php echo e($item->kuantitas); ?> x Rp <?php echo e(number_format($item->harga_satuan ?? ($item->subtotal / max($item->kuantitas, 1)), 0, ',', '.')); ?>
    ...
    <table style="width: 100%; font-size: 10px; font-weight: bold; color: #8b5cf6;">
        <tr>
            <td>TOTAL BAYAR</td>
            <td style="text-align: right;">Rp <?php echo e(number_format($penjualan->total_pembayaran, 0, ',', '.')); ?></td>
        </tr>
    </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/penjualan/show.blade.php ENDPATH**/ ?>